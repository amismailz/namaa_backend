...
class LocationPickerInput extends Field
{

    protected string $view = 'forms.components.location-picker-input';
    ...
    // {
    //     return view('forms.components.location-picker-input');
    // }
    ...
    public function getDefaultLocation(): array
    {
        ...
        fwrite(fopen('php://stdout', 'w'), print_r($position, true));
    ...
    {
        return env('GMAP_API', "AIzaSyAd4wZ0etrPaxFxUoxxBYXnUmUFB8N2NzM");
    }
