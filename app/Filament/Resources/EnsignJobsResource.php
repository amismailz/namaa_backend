...
use App\Filament\Resources\EnsignJobsResource\Pages;
use App\Filament\Resources\EnsignJobsResource\RelationManagers;
...
class EnsignJobsResource extends Resource
{
    protected static ?string $model = EnsignJobs::class;
    ...
    {
        return [
            'index' => Pages\ListEnsignJobs::route('/'),
            'create' => Pages\CreateEnsignJobs::route('/create'),
            'edit' => Pages\EditEnsignJobs::route('/{record}/edit'),
        ];
    }
}
